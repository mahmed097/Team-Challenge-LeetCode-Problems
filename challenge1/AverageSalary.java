...
class AverageSalary {
	public double average(int[] salary) {
		...
		double sum = 0;
		int min = (int) Math.pow(10, 7); // Initializing minimum salary and setting it to a number outside our
											// constraints (Which was 1000 <= salary[i] <= 10^6)
		int max = 999; // Initializing maximum salary and setting it to a number outside our
						// constraints (Which was 1000 <= salary[i] <= 10^6)
